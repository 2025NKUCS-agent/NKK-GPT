...
from nkkagent.prompt.browser import NEXT_STEP_PROMPT, SYSTEM_PROMPT
from nkkagent.schema.message import Message, ToolChoice
...
if TYPE_CHECKING:
    from nkkagent.agent.baseagent import BaseAgent  # Or wherever memory is defined

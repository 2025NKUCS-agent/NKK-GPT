...
def get_nkkagent_package_root():
    """Get the root directory of the nkkagent package."""
    package_root = Path(nkkagent.__file__).parent.parent
...
def get_nkkagent_root():
    """Get the root directory of the nkkagent project."""
    # Check if a project root is specified in the environment variable
    project_root_env = os.getenv("NKKAGENT_PROJECT_ROOT")
    if project_root_env:
        ...
        project_root = get_nkkagent_package_root()
    return project_root
...
NKKAGENT_ROOT = get_nkkagent_root()  # Dependent on NKKAGENT_PROJECT_ROOT
DEFAULT_WORKSPACE_ROOT = NKKAGENT_ROOT / "workspace"

EXAMPLE_PATH = NKKAGENT_ROOT / "examples"
EXAMPLE_DATA_PATH = EXAMPLE_PATH / "data"
DATA_PATH = NKKAGENT_ROOT / "data"
DABENCH_PATH = EXAMPLE_PATH / "di/InfiAgent-DABench/data"
EXAMPLE_BENCHMARK_PATH = EXAMPLE_PATH / "data/rag_bm"
TEST_DATA_PATH = NKKAGENT_ROOT / "tests/data"
...
TMP = NKKAGENT_ROOT / "tmp"

SOURCE_ROOT = NKKAGENT_ROOT / "nkkagent"
PROMPT_PATH = SOURCE_ROOT / "prompts"
SKILL_DIRECTORY = SOURCE_ROOT / "skills"
TOOL_SCHEMA_PATH = NKKAGENT_ROOT / "nkkagent/tools/schemas"
TOOL_LIBS_PATH = NKKAGENT_ROOT / "nkkagent/tools/libs"

...
class GitTool(BaseTool):
    name: str = "git"
    description: str = "Git version control system operations"
    parameters: Optional[dict] = {
        "type": "object",
        "properties": {
            "operation": {
                "type": "string",
                "enum": [op.value for op in GitTools],
            ...
            "message": {
                "type": "string",
                "description": "Commit message for git commit operations"
            },
            "files": {
                "type": "array",
                "items": {"type": "string"},
                "description": "List of files for git add operations"
            },
            "target": {
                "type": "string",
                "description": "Target branch or commit for git diff operations"
            },
            "branch_name": {
                "type": "string",
                "description": "Branch name for git branch operations"
            },
            "base_branch": {
                "type": "string",
                "description": "Base branch for git branch creation"
            },
            "revision": {
                "type": "string",
                "description": "Revision for git show operations"
            },
            "max_count": {
                "type": "integer",
                "description": "Maximum number of commits to show in git log"
            }
        },
    ...
    async def execute(self, **kwargs) -> Any:
        """Execute git operations based on the provided parameters."""
        operation = kwargs.get("operation")
        repo_path = Path(kwargs.get("repo_path"))

        # Handle git init separately since it doesn't require an existing repo
        if operation == GitTools.INIT:
            return git_init(str(repo_path))
